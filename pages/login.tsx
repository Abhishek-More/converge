...
export default function Login() {
  ...
  return (
    <div
      className={`bg-black h-screen flex flex-col items-center flex-1 px-20 text-center `}
    >
      <Navbar />
      
      <div className="grid grid-cols-2 ">
        <div className="space-y-4 px-8">
              <h1 className=" leading-[80px] text-[80px] font-bold text-1first mt-60 font-poppins linear-wipe">
              <p>Education that understands you.</p>
            </h1>


            <div className="leading-[30px] align-middle pt-5 pb-12 text-[26px] text-white font-poppins px-12">
              <p>Fostering a virtual environment that empowers students to learn, connect, and grow--together</p>
            </div>

            <div className="flex justify-center space-x-12">
              <button
                className=" px-8 bg-white  text-chalk font-semibold rounded-lg font-poppins"
                onClick={() => signIn("google")}>
                Get Started
              </button>
              <Link href="/resources">
                <p className="py-2 px-8 text-white border-2 border-white font-semibold rounded-lg">
                  Learn More
                </p>
              </Link>
            </div>
